...
try {
  ...
  if (mobile.overflow || mobile.narrow.length) failures.push('ASD 核心訓練室：375px 行動版有橫向溢出或小於 40px 的控制。');
