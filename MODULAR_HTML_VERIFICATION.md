...
公開 `index.html?senType=SpLD&stageLevel=S1–S3` 已顯示初中 12 關基礎練習及六張直接選關卡：關聯詞轉盤、段落結構大洗牌、文章冗詞除錯、修辭手法分類卡、成語圖解猜謎、主旨提煉篩選器。關聯詞轉盤首關已驗證正常開啟，並顯示第 1 / 10 關、轉折關係、三個選項、朗讀題目、看提示及換一項練習控制。提示會顯示句意線索；正確選擇「然而」後，流程正常前進至第 2 / 10 關。段落結構大洗牌的首關亦已確認正常開啟，顯示時間順序、三個排序欄位和三張可點選句子卡；點選首句後會即時置入第一格並顯示「慢慢看下一句」提示。文章冗詞除錯的首關也已驗證，會顯示原句、精煉問題、三個可選字詞及同一組低壓工具。公開模組介面進一步確認六款遊戲均各自提供 10 個短回合；其餘修辭、成語與主旨題庫已在同一版本化腳本內供主頁直接開啟。
