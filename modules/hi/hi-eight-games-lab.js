...
(function () {
  ...
  const games = {
    lower: [
      { key: 'rainbow', icon: '🌈', title: '聲波彩虹橋', focus: '高音與低音辨識', description: '按一下才播放聲音，再用星星或雲朵配對音高；每一步都有色彩線索。', steps: 3 },
      { key: 'tones', icon: '🎢', title: '廣東話聲調「過山車」', focus: '視覺化聲調曲線', description: '把平穩或向上走的音高線，配對到清楚的文字和軌道圖。', steps: 3 }
    ],
    upper: [
      { key: 'lips', icon: '🕵️', title: '神探唇讀術：校園密碼', focus: '口型與字卡提示', description: '先看清楚的嘴型圖與發音線索，再選出同學或老師的訊息。', steps: 3 },
      { key: 'expression', icon: '🙂', title: '表情與聲音的「連連看」', focus: '語氣與臉部線索', description: '用文字、語氣描述和表情一起理解完整溝通訊息。', steps: 3 }
    ],
    junior: [
      { key: 'noise', icon: '📡', title: '「課室開學：降噪大作戰」', focus: '信噪比與 FM 系統', description: '在視覺化嘈雜課室中，先開啟 FM 輔具，再找出班長提及的用品。', steps: 3 },
      { key: 'shield', icon: '🛡️', title: '小組研習的「溝通盾牌」', focus: '自我倡導對白', description: '遇到說話太快或背向說話時，練習提出清晰、禮貌的支援需要。', steps: 3 }
    ],
    senior: [
      { key: 'takeaway', icon: '🍜', title: '繁忙茶餐廳：外賣接單王', focus: '高噪環境關鍵詞', description: '閱讀訂單字幕與視覺噪音線索，逐步輸入食物、飲品要求及送貨樓層。', steps: 3 },
      { key: 'dse', icon: '🎧', title: 'DSE 聆聽試：無障礙考場模擬', focus: '輔具預檢與求助', description: '完成設備檢查，遇到訊號問題時練習即時舉手求助。', steps: 3 }
    ]
  };
