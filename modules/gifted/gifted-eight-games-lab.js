...
(() => {
  ...
  achievementRounds.push(
    {title:'學期中段',scenario:'虛構角色正在安排測驗、小組創作和休息。',cards:['學習線索：把一個難題拆成兩個小步。','創作線索：保留一段自由試作時間。','休息線索：安排短暫離開螢幕。'],prompt:'在測驗、創作和休息之間，選一至兩張想保留的平衡卡；也可以略過。'},
    {title:'義工活動後',scenario:'虛構角色完成社區義工活動，想整理投入和下一步。',cards:['關係線索：記下合作中一件有效做法。','生活線索：安排補充體力的休息。','學習線索：寫下一個仍想了解的需要。'],prompt:'回顧義工活動後，選一至兩張能幫你整理合作和下一步的卡；也可以略過。'},
    {title:'創作卡關時',scenario:'虛構角色的作品尚未完成，想兼顧嘗試和照顧自己。',cards:['創作線索：換一種素材試作十分鐘。','支持線索：請一位可信任的人看一小部分。','休息線索：先離開作品再回來。'],prompt:'作品卡關時，選一至兩張可幫你嘗試或休息的卡；也可以略過。'},
    {title:'新學期開始',scenario:'虛構角色要安排新課、興趣和人際連結。',cards:['規劃線索：先寫下第一週最重要的一件事。','好奇線索：保留一個想探索的問題。','關係線索：找一位可以互相提醒的人。'],prompt:'開始新學期時，選一至兩張能幫你規劃、探索或連結的卡；也可以略過。'},
    {title:'完成比賽後',scenario:'虛構角色剛完成一場比賽，想回顧投入而不是只看結果。',cards:['學習線索：寫下一個下次想試的策略。','關係線索：感謝一位曾支持的人。','生活線索：安排回復精神的活動。'],prompt:'完成比賽後，選一至兩張能幫你回顧投入和回復精神的卡；也可以略過。'}
  );
  valuesRounds.push(
