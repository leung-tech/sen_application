(() => {
  const ACTIVITIES = {
    ...
    'word-net': {
      ...
      rounds: [
        { silhouette: '🦒', prompt: '根據三條線索，找出最相符的字詞魚。', clues: ['有很長的頸', '常見於非洲草原', '身上有斑點'], choices: ['長頸鹿', '斑馬', '大象'], answer: '長頸鹿', hint: '可先把三條線索分成外形、地方和特徵；不需要急著選。', success: '你把不同線索連到同一個詞語。' },
        { silhouette: '🔭', prompt: '根據三條線索，找出最相符的字詞魚。', clues: ['可以看遠處的物件', '有鏡片', '觀星時可能會用到'], choices: ['望遠鏡', '顯微鏡', '放大鏡'], answer: '望遠鏡', hint: '先看用途：它用來看遠處，不是看很小的東西。', success: '你慢慢用用途和特徵找到了詞語。' },
        { silhouette: '🌋', prompt: '根據三條線索，找出最相符的字詞魚。', clues: ['是一種自然地貌', '有時會噴出熔岩', '地底的力量會推動它'], choices: ['火山', '瀑布', '沙丘'], answer: '火山', hint: '可以先想哪一個地方會和熔岩有關。', success: '你用關鍵線索選出了相符詞語。' }
      ]
    },
    'pace-route': {
    ...
    'discussion-scaffold': {
      ...
      rounds: [
        ...
        { topic: '學校應否保留安靜閱讀時間？', prompt: '把一個可討論的觀點按結構卡組合。', answer: ['我的立場：應保留每週安靜閱讀時間。', '理據：不同學生需要固定時間慢慢閱讀。', '例子／回應：可提供不同難度和紙本／電子選擇。', '總結：彈性安排可讓更多學生參與。'], choices: ['理據：不同學生需要固定時間慢慢閱讀。', '總結：彈性安排可讓更多學生參與。', '我的立場：應保留每週安靜閱讀時間。', '例子／回應：可提供不同難度和紙本／電子選擇。'], labels: ['我的立場', '理據', '例子／回應', '總結'], hint: '不用追求一個「最強」答案；先令每一張卡在結構中有清楚作用。', success: '你把立場、理由、例子和總結連成了一段完整想法。' },
        { topic: '校園活動應否讓學生參與路線設計？', prompt: '把一個可討論的觀點按結構卡組合。', answer: ['我的立場：可讓學生參與部分路線設計。', '理據：可收集不同使用者的需要。', '例子／回應：同時要由教師核對安全和時間安排。', '總結：一起設計可兼顧參與和實際限制。'], choices: ['例子／回應：同時要由教師核對安全和時間安排。', '我的立場：可讓學生參與部分路線設計。', '總結：一起設計可兼顧參與和實際限制。', '理據：可收集不同使用者的需要。'], labels: ['我的立場', '理據', '例子／回應', '總結'], hint: '一段有組織的意見可以同時說出好處和實際限制。', success: '你清楚安排了立場、理由、回應和結論。' }
      ]
    },
    'voice-use': {
