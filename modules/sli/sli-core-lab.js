(() => {
  const ACTIVITIES = {
    ...
    factory: {
      ...
      rounds: [
        { prompt: '砌出一句「誰／在哪裏／做甚麼」的句子。', answer: ['小貓', '喺天台', '訓覺'], choices: ['小貓', '喺天台', '訓覺'], labels: ['誰', '在哪裏', '做甚麼'], hint: '先找角色「小貓」，再想牠在哪裏和在做甚麼。' },
        { prompt: '砌出一句「誰／在哪裏／做甚麼」的句子。', answer: ['阿明', '喺圖書館', '睇書'], choices: ['睇書', '阿明', '喺圖書館'], labels: ['誰', '在哪裏', '做甚麼'], hint: '句子開始的人物是「阿明」。' },
        { prompt: '砌出一句「誰／在哪裏／做甚麼」的句子。', answer: ['妹妹', '喺廚房', '洗碗'], choices: ['喺廚房', '洗碗', '妹妹'], labels: ['誰', '在哪裏', '做甚麼'], hint: '先放人物「妹妹」，最後才放動作「洗碗」。' }
      ]
    },
    timeline: {
    ...
    emotion: {
      ...
      rounds: [
        { face: '😞', context: '小美的作品被雨水弄濕了，她低頭不說話。', prompt: '你可以怎樣回應？', choices: ['你想我陪你一起看看嗎？', '這有甚麼好傷心？', '你一定要立刻再做一份。'], answer: '你想我陪你一起看看嗎？', hint: '她可能感到失望；先關心和提出小幫忙。', teacher: '可問學生：「小美的臉和身體告訴你甚麼？」' },
        ...
        { face: '😟', context: '朋友不停望著鐘，說「我怕趕不及交功課」。', prompt: '你可以先怎樣說？', choices: ['我們先看哪一部分最急。', '你不用理它。', '你現在一定做不完。'], answer: '我們先看哪一部分最急。', hint: '先把大問題變成眼前的一小步。', teacher: '可讓學生指「先做哪一部分」而不必說完整句子。' }
      ]
    },
    courier: {
  ...
  function finish() {
    clearTimers(); stopRecorder(); const activity = activeActivity();
