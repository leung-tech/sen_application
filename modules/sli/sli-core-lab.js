(() => {
  ...
  const EXTRA_ROUNDS = {
    ...
    subtext:[
      ...
      {quote:'「我收到了，等我睇完先。」',context:'你傳了一份較長的文件給同學。',prompt:'收到同學說會先閱讀後，怎樣跟進較穩妥？',choices:['等對方看完再跟進','立刻連續傳很多訊息','認定對方不會看'],answer:'等對方看完再跟進',follow:'好，你看完後方便時再回覆我。',hint:'對方已說明會先閱讀。'}],
    debate:[
