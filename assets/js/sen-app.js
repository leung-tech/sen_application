    (() => {
      ...
      function renderGameLibrary(filter = activeFilter) {
        ...
        $('#gameGrid').innerHTML = asdFifteenDirectCard + asdDirectCard + asdEightDirectCard + adhdFifteenDirectCard + adhdDirectCard + idFifteenDirectCard + idDirectCard + idEightDirectCard + idAdvancedDirectCard + sliFifteenDirectCard + hiEightDirectCard + viDirectCard + pdDirectCard + games.map(game => {
