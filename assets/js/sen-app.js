    (() => {
      ...
      function renderGameLibrary(filter = activeFilter) {
        ...
        $('#gameGrid').innerHTML = asdDirectCard + asdEightDirectCard + adhdDirectCard + idFifteenDirectCard + idDirectCard + idEightDirectCard + idAdvancedDirectCard + hiEightDirectCard + viDirectCard + pdDirectCard + games.map(game => {
