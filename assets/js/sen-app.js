    (() => {
      ...
      function renderAdhdDashboard() {
        ...
        dashboard.insertAdjacentHTML('beforeend', `${renderAdhdLabSummary()}<div class="adhd-lab-entry"><div><strong>🎯 分級專注實驗室</strong><span>色字干擾、反應抑制與持續注意；可按學生狀態選短、中或長挑戰。</span></div><button class="timer-control" id="adhdFocusLabLaunch" type="button">開啟專注挑戰</button></div>`);
